<template>
  <el-card>
    <!-- 面包屑导航 -->
    <Mybread :navone="'商品管理'" :navtwo="'商品分类'"/>
    <!-- 添加按钮 -->
    <el-row>
      <el-col :span="4">
    ...
    <el-table :data="pageList" style="width: 100%">
      <el-table-tree-column file-icon="icon icon-file" folder-icon="icon icon-folder" 
      prop="cat_name" label="名称" treeKey="cat_id" parentKey="cat_pid" levelKey="cat_level">
    ...
    <!-- 
        el-pagination：分页组件
            ...
            total：总数据条数
     -->
    <el-pagination :current-page="currentpage" :page-sizes="pagesizes" :page-size="pagesize" layout="total, sizes, prev, pager, next, jumper" 
